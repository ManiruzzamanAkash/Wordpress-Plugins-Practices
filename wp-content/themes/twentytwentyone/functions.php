...
/** PLUGIN : Word Count Implementation */
...
/** PLUGIN : R Code Implementation */
function twentytwentyone_exclude_post_types($post_types)
{
	$post_types[] = 'page';
	return $post_types;
}
add_filter('pqrc_exclude_post_types', 'twentytwentyone_exclude_post_types');

function twentytwentyone_pqrc_qrcode_dimension($dimension)
{
	return '50x50';
}
add_filter('pqrc_qrcode_dimension', 'twentytwentyone_pqrc_qrcode_dimension');

function twentytwentyone_pqrc_extra_attributes($attributes)
{
